...
{
    public class DefaultBoyingEventBus : IEventBus
    {
        ...
        public DefaultBoyingEventBus(IIndex<string, IEnumerable<IEventHandler>> eventHandlers, IExceptionPolicy exceptionPolicy)
        {
