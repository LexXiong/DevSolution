...
namespace Boying.Data.Providers
{
    public class PostgreSqlDataServicesProvider : AbstractDataServicesProvider
    {
        ...
        private sealed class PostgreSql82DialectFixed : PostgreSQL82Dialect
        {
        ...
        private sealed class PostgreSql82Configuration : PersistenceConfiguration<PostgreSql82Configuration>
        {
