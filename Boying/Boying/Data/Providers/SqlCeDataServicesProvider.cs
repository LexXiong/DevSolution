...
namespace Boying.Data.Providers
{
    public class SqlCeDataServicesProvider : AbstractDataServicesProvider
    {
        ...
        public SqlCeDataServicesProvider(string dataFolder, string connectionString)
        {
            ...
            _fileName = Path.Combine(_dataFolder, "Boying.sdf");
        }
        ...
        public override IPersistenceConfigurer GetPersistenceConfigurer(bool createDatabase)
        {
            ...
            persistence = persistence.Driver(typeof(BoyingSqlServerCeDriver).AssemblyQualifiedName);
            return persistence;
        }
        ...
        public class BoyingSqlServerCeDriver : SqlServerCeDriver
        {
