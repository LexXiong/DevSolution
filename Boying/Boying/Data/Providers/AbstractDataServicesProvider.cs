...
namespace Boying.Data.Providers
{
    ...
    public abstract class AbstractDataServicesProvider : IDataServicesProvider
    {
        ...
        public Configuration BuildConfiguration(SessionFactoryParameters parameters)
        {
            ...
            config = config.Database(database)
                           ...
                           .ExposeConfiguration(cfg =>
                           {
                               ...
                               cfg.EventListeners.LoadEventListeners = new ILoadEventListener[] { new BoyingLoadEventListener() };
        ...
        [Serializable]
        private class BoyingLoadEventListener : DefaultLoadEventListener, ILoadEventListener
        {
