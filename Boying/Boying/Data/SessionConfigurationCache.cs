...
namespace Boying.Data
{
    public class SessionConfigurationCache : ISessionConfigurationCache
    {
        ...
        private Hash ComputeHash()
        {
            ...
            // Boying version, to rebuild the mappings for each new version
            var BoyingVersion = new System.Reflection.AssemblyName(typeof(BoyingServices).Assembly.FullName).Version.ToString();
            hash.AddString(BoyingVersion);
