...
namespace Boying.Environment.ShellBuilders
{
    ...
    public interface IShellContextFactory
    {
        ...
        /// <summary>
        /// Builds a shell context for an uninitialized Boying instance. Needed
    ...
    public class ShellContextFactory : IShellContextFactory
    {
        ...
        private static ShellDescriptor MinimumShellDescriptor()
        {
            return new ShellDescriptor
            {
                SerialNumber = -1,
                Features = new[] {
                    new ShellFeature {Name = "Boying.Framework"},
        ...
        public ShellContext CreateSetupContext(ShellSettings settings)
        {
            ...
            var descriptor = new ShellDescriptor
            {
                SerialNumber = -1,
                Features = new[] {
                    new ShellFeature { Name = "Boying.Setup" },
                    new ShellFeature { Name = "Shapes" },
                    new ShellFeature { Name = "Boying.Resources" }
                },
            };
