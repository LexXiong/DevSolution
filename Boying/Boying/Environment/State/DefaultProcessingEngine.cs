...
namespace Boying.Environment.State
{
    public class DefaultProcessingEngine : Component, IProcessingEngine
    {
        ...
        private readonly Func<IBoyingHost> _BoyingHost;

        private readonly ContextState<IList<Entry>> _entries;

        public DefaultProcessingEngine(IShellContextFactory shellContextFactory, Func<IBoyingHost> BoyingHost)
        {
            _shellContextFactory = shellContextFactory;
            _BoyingHost = BoyingHost;
