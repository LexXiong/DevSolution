...
namespace Boying.Environment.AutofacUtil.DynamicProxy2
{
    ...
    {
        private const string ProxyContextKey = "Boying.Environment.AutofacUtil.DynamicProxy2.DynamicProxyContext.ProxyContextKey";
        private const string InterceptorServicesKey = "Boying.Environment.AutofacUtil.DynamicProxy2.DynamicProxyContext.InterceptorServicesKey";
