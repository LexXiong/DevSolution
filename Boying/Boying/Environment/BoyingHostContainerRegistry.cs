...
{
    /// <summary>
    /// Provides ability to connect Shims to the BoyingHostContainer
    /// </summary>
    public static class BoyingHostContainerRegistry
    {
        private static readonly IList<Weak<IShim>> _shims = new List<Weak<IShim>>();
        private static IBoyingHostContainer _hostContainer;
        ...
        public static void RegisterHostContainer(IBoyingHostContainer container)
        {
            lock (_syncLock)
            {
                CleanupShims();
