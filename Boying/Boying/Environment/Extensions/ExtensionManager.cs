    ...
    public class ExtensionManager : IExtensionManager
    {
        ...
        private Feature LoadFeature(FeatureDescriptor featureDescriptor)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new BoyingException(T("Error while loading extension '{0}'.", extensionId), ex);
            }
        ...
        {
            foreach (BoyingFeatureAttribute featureAttribute in type.GetCustomAttributes(typeof(BoyingFeatureAttribute), false))
            {
