...
using Boying.Mvc.ModelBinders;
using Boying.Mvc.Routes;
using Boying.Owin;
using Boying.Tasks;
using Boying.UI;
using Boying.WebApi.Routes;
using IModelBinderProvider = Boying.Mvc.ModelBinders.IModelBinderProvider;

namespace Boying.Environment
{
    public class DefaultBoyingShell : IBoyingShell
    {
        ...
        public void Activate()
        {
            ...
            // Register the Boying middleware after all others.
            appBuilder.UseBoying();
            ...
            {
                using (var events = scope.Resolve<Owned<IBoyingShellEvents>>())
                {
