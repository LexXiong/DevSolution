...
{
    public class DefaultBoyingHostContainer : IBoyingHostContainer, IDependencyResolver
    {
        private readonly IContainer _container;

        public DefaultBoyingHostContainer(IContainer container)
        {
        ...
        TService IBoyingHostContainer.Resolve<TService>()
        {
