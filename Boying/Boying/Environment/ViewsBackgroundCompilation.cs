        ...
        private void CompileViews(object sender, ElapsedEventArgs elapsedEventArgs)
        {
            ...
            var context = new CompilationContext
            {
                ...
                DirectoriesToBrowse = new[] {
                    ...
                    // Content Items
                    "~/Modules/Boying.PublishLater/Views",

                    // Content Types
                    "~/Modules/Boying.ContentTypes/Views",

                    // "Edit" homepage
                    "~/Modules/TinyMce/Views",
                    "~/Modules/Boying.Tags/Views",
                    "~/Core/Navigation/Views",

                    // Various other admin pages
                    "~/Core/Settings/Views",
                    "~/Core/Containers/Views",
                    "~/Modules/Boying.Widgets/Views",
                    "~/Modules/Boying.Users/Views",
                    "~/Modules/Boying.MediaLibrary/Views",
                    "~/Modules/Boying.Comments/Views",
