using System;
using Boying.Localization.Models;

namespace Boying.Localization.Services
{
    /// <summary>
    /// Provides conversion and formatting of dates according to the Boying configured
    ...
    {
        /// <summary>
        /// Converts a date from UTC to the Boying configured time zone.
        /// </summary>
        ...
        /// <summary>
        /// Converts a date from the Boying configured time zone to UTC.
        /// </summary>
        ...
        /// <summary>
        /// Converts a date from Gregorian calendar to the Boying configured calendar.
        /// </summary>
        ...
        /// <summary>
        /// Converts a date from the Boying configured calendar to Gregorian calendar.
        /// </summary>
        /// <param name="parts">A <c>DateTimeParts</c> instance representing the Boying configured calendar date to convert.</param>
