...
namespace Boying.Localization.Services
{
    public class DefaultLocalizedStringManager : ILocalizedStringManager
    {
        ...
        private const string CoreLocalizationFilePathFormat = "~/Core/App_Data/Localization/{0}/Boying.core.po";
        private const string ModulesLocalizationFilePathFormat = "{0}/App_Data/Localization/{1}/Boying.module.po";
        private const string ThemesLocalizationFilePathFormat = "{0}/App_Data/Localization/{1}/Boying.theme.po";
        private const string RootLocalizationFilePathFormat = "~/App_Data/Localization/{0}/Boying.root.po";
        private const string TenantLocalizationFilePathFormat = "~/App_Data/Sites/{0}/Localization/{1}/Boying.po";
        ...
        // "~/Core/App_Data/Localization/<culture_name>/Boying.core.po";
        // "~/Modules/<module_name>/App_Data/Localization/<culture_name>/Boying.module.po";
        // "~/Themes/<theme_name>/App_Data/Localization/<culture_name>/Boying.theme.po";
        // "~/App_Data/Localization/<culture_name>/Boying.root.po";
        // "~/App_Data/Sites/<tenant_name>/Localization/<culture_name>/Boying.po";
