...
namespace Boying.Exceptions
{
    public class DefaultExceptionPolicy : IExceptionPolicy
    {
        ...
        public bool HandleException(object sender, Exception exception)
        {
            ...
            if (sender is IEventBus && exception is BoyingFatalException)
            {
                return false;
            }
        ...
        {
            return
                exception is BoyingSecurityException ||
        ...
        private void RaiseNotification(Exception exception)
        {
            ...
            {
                _notifier.Error((exception as BoyingException).LocalizedMessage);
            }
