...
namespace Boying.Security.Providers
{
    public class FormsAuthenticationService : IAuthenticationService
    {
        ...
        // user name not mapped to an actual Boying user content item. If the request is
        ...
        // remember if the current user is a non-Boying user between invocations.
        private bool _isNonBoyingUser;
