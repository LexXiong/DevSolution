...
{
    public class DefaultBoyingWebApiHttpControllerActivator : IHttpControllerActivator
    {
        private readonly HttpConfiguration _configuration;

        public DefaultBoyingWebApiHttpControllerActivator(HttpConfiguration configuration)
            : base()
        {
