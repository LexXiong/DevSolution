...
using Boying.WebApi.Extensions;

namespace Boying.WebApi
{
    public class DefaultBoyingWebApiHttpControllerSelector : DefaultHttpControllerSelector, IHttpControllerSelector
    {
        private readonly HttpConfiguration _configuration;

        public DefaultBoyingWebApiHttpControllerSelector(HttpConfiguration configuration) : base(configuration)
        {
