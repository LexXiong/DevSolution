...
{
    [Serializable]
    public class BoyingLog4netLogger : MarshalByRefObject, Logger, IShim
    {
        private static readonly Type declaringType = typeof(BoyingLog4netLogger);

        private readonly Lazy<ShellSettings> _shellSettings;

        public IBoyingHostContainer HostContainer { get; set; }

        public BoyingLog4netLogger(log4net.Core.ILogger logger, BoyingLog4netFactory factory)
        {
        ...
        internal BoyingLog4netLogger()
        {
        }

        internal BoyingLog4netLogger(ILog log, BoyingLog4netFactory factory)
        ...
        private ShellSettings LoadSettings()
        {
            ...
            var BoyingHost = HostContainer.Resolve<IBoyingHost>();
            if (BoyingHost == null)
                return null;

            var shellContext = BoyingHost.GetShellContext(shellSettings);
        ...
        protected internal BoyingLog4netFactory Factory { get; set; }
