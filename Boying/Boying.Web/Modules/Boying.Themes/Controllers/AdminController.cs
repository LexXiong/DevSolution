...
namespace Boying.Themes.Controllers {
    ...
    public class AdminController : Controller {
        ...
        private const string AlreadyEnabledFeatures = "Boying.Themes.AlreadyEnabledFeatures";
