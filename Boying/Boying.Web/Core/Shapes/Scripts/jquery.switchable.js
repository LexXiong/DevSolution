(function ($) {
    $.fn.extend({
        powerUpTheSwitch: function () {
            ...
            var setting = $.Boying.setting("switchable", { path: document.location.pathname })
        ...
        switchToDetailView: function (switched) {
            $.Boying.setting("switchable", "detail-view", { path: document.location.pathname });
        ...
        switchToSummaryView: function (switched) {
            $.Boying.setting("switchable", "summary-view", { path: document.location.pathname });
