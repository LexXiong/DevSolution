...
using Boying.DisplayManagement.Descriptors.ResourceBindingStrategy;
...
using Boying.UI.Zones;
using Boying.Utility.Extensions;

// ReSharper disable InconsistentNaming

namespace Boying.Core.Shapes
{
    public class CoreShapes : IShapeTableProvider
    {
            ...
            /*object RouteValues*/)
        {
            ...
            // specific cross-requests route data can be passed to the shape directly (e.g., Boying.Users)
