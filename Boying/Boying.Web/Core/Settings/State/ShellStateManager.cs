...
using Boying.Core.Settings.State.Records;
using Boying.Data;
...
namespace Boying.Core.Settings.State
{
    public class ShellStateManager : Component, IShellStateManager
    {
        ...
        {
            //Fix for https://Boying.codeplex.com/workitem/21176 / https://github.com/BoyingCMS/Boying/issues/6075 change to get ensure ShellState record only retrieved once.
